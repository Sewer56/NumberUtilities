...
namespace Sewer56.NumberUtilities.Helpers
{
    /// <summary>
    /// Wraps an enumerable in a struct, with support for implicit conversion between the enum and common primitives.
    /// </summary>
    /// <typeparam name="T">An enumerable with an unmanaged underlying type.</typeparam>
